...
const images = [
  {
    ...
    description: `It is a massive defensive construction and an open-air museum of Soviet heroic monumental art. The fortress was built in the 19th century and its history is pretty impressive. In 1596 Union of Brest was announced here, much later there was signed the Treaty of Brest-Litovsk that ended the participation of the Soviet Russia in the WWI. But the fortress became really famous after the heroic events of the WWII.
      ...
      Then head for the Museum of the Defenders of the Brest Fortress. Its territory is huge, but the most thrilling spot is the Fifth Fort, an abandoned construction with armoured doors, thin shot holes, underground passages, and complete silence. You must be the only tourist there.`
  },
  {
